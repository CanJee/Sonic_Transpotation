...
Template.adminReservations.rendered = function(){

};

Template.adminReservations.helpers({
  reservations() {
...
Template.adminReservation.rendered = function() {
	Meteor.defer(function () {
    	$('.reservations-list').footable();
    });
};

Template.adminReservation.events({
